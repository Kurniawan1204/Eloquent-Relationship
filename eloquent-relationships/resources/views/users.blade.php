    ...
    <div class="container">
        <div class="card mt-5">
            <div class="card-body bg-warning">
                <h3 class="text-center"><a href="https://santrikoding.com">Wan.com</a></h3>
                <h5 class="text-center my-4">Laravel Eloquent Relationship : One To One & Many To Many</h5>
                <a class="btn btn-success mb-3" href="#">Tambahkan</a>
                <table class="table table-borderles bg-white table-striped">
                    <thead>
                        <tr>
                            <th>Nama User</th>
                            <th>Nomor Telepon</th>
